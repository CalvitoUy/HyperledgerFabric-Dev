...
./home/hlfuser/Downloads/install.sh | bash
...
# si estas atraz de un proxy debes crear el archivo ~./curlrc y y agregar la siguiente linea
# proxy = http://username:password@proxy-host:port
# si los problemas siguen junto al -L agrega una v (-Lv) para ver el detalle de lo que pasa
echo "# Installing Docker-Compose"
sudo -E curl -L "https://github.com/docker/compose/releases/download/1.13.0/docker-compose-$(uname -s)-$(uname -m)" \
